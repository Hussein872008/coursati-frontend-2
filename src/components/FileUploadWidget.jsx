...
const FileUploadWidget = ({ 
	...
	const getLabelText = () => {
		switch(fileType) {
			case 'image':
				return { upload: 'رفع الصورة', change: 'تغيير الصورة', uploading: 'جاري رفع الصورة...' };
			case 'pdf':
				return { upload: 'رفع PDF', change: 'تغيير PDF', uploading: 'جاري رفع PDF...' };
			case 'video':
				return { upload: 'رفع الفيديو', change: 'تغيير الفيديو', uploading: 'جاري رفع الفيديو...' };
			default:
				return { upload: 'رفع ملف', change: 'تغيير الملف', uploading: 'جاري الرفع...' };
		}
	};
