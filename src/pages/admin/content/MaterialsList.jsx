  ...
  return (
    <div className="min-h-screen p-4 md:p-6">
      ...
      <div className="relative z-10">
        ...
        {/* Header */}
        <div className="admin-card p-2 md:p-8 mb-8 bg-gradient-to-r from-gray-800/60 via-gray-900/60 to-gray-800/60 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl ring-1 ring-white/5 overflow-hidden">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center gap-4 bg-gray-900/40 backdrop-blur-sm rounded-2xl p-4 border border-white/10 shadow-lg ring-1 ring-white/6">
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="p-6 rounded-3xl bg-gradient-to-r from-gray-800/30 to-gray-900/30 backdrop-blur-sm border border-white/8 animate-pulse shadow-inner"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              ...
              {materials.map((material) => (
                ...
                >
                  <div className={`absolute inset-0 bg-gradient-to-r from-cyan-500/12 via-blue-500/10 to-purple-500/12 rounded-3xl blur-2xl transition-opacity duration-500 ${hoveredCard === material._id ? "opacity-100" : "opacity-0"}`} />

                  <div className="relative bg-gradient-to-r from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-white/8 rounded-3xl p-3 md:p-4 hover:border-cyan-500/30 hover:shadow-2xl hover:shadow-cyan-500/12 transition-transform duration-300 w-full min-h-[220px] hover:scale-[1.02] focus-within:scale-[1.02]">
                    <div className="flex flex-col gap-4 items-start">
                      <div className="w-full aspect-[4/3] flex-shrink-0 rounded-xl overflow-hidden border-2 border-white/10 transition-colors duration-300 mx-auto relative shadow-[0_8px_30px_rgba(2,6,23,0.6)] bg-gradient-to-br from-gray-800/20 to-gray-900/20">
                        {material.thumbnailUrl || material.thumbnail ? (
                          <img
                            src={material.thumbnailUrl || material.thumbnail}
                            alt={material.title}
                            className="w-full h-full object-contain object-center transition-transform duration-400 ease-out group-hover:scale-105"
                            loading="lazy"
                            decoding="async"
                          />
                        ) : (
                        ...
                        <div className="absolute left-3 top-3">
                          <span
                            ...
                            className={`inline-flex items-center gap-1 bg-black/60 text-white text-xs px-2 py-1 rounded-full backdrop-blur-sm select-none ${isSmall ? "cursor-pointer underline" : ""}`}
                        ...
                        <div className="absolute right-3 top-3">
                          <span className="inline-flex items-center gap-1 bg-black/50 text-white text-xs px-2 py-1 rounded-full backdrop-blur-sm border border-white/6">
                        ...
                        <div className="absolute right-3 bottom-3">
                          <h3 className="text-sm font-semibold text-white bg-black/60 px-3 py-1 rounded-full line-clamp-1  text-right">{material.title}</h3>
                        </div>
                      </div>
              ...
              >
                ...
                <div
                  ...
                  } rounded-3xl p-4 md:p-6 cursor-pointer transition-all duration-500 w-full min-h-[220px] ${!showForm ? "md:hover:shadow-2xl md:hover:shadow-emerald-500/10 md:hover:-translate-y-1" : ""}`}
                >
                    {!showForm ? (
                      ...
                      <div className="w-full h-36 flex-shrink-0 rounded-xl bg-gradient-to-br from-emerald-900/36 to-teal-900/36 border-2 border-emerald-500/20 flex items-center justify-center group-hover:border-emerald-500/40 transition-colors duration-300 shadow-md">
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                      ...
                      >
                        {/* Image Upload Section - First */}
                            <div className="w-full aspect-[4/3] flex-shrink-0 mx-auto">
                              <div className="w-full h-full rounded-xl overflow-hidden border border-white/10 relative flex flex-col bg-gradient-to-br from-gray-800/30 to-gray-900/30">
                            {formData.thumbnail ? (
                              ...
                              <div className="w-full h-full bg-gradient-to-br from-gray-700/80 to-gray-900/80 flex flex-col items-center justify-center p-3">
                                <div className="relative w-full h-full border-2 border-dashed border-white/30 rounded-lg hover:border-emerald-400/50 transition-colors duration-300 group bg-white/2">
