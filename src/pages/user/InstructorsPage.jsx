    ...
    return (
      <div className="min-h-screen  flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60 text-sm mt-2">جاري تحميل المادة والمدرسين</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen " dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 p-6">
          ...
          <div className="mb-8 p-6 rounded-2xl bg-gradient-to-r from-white/5 to-white/10 border border-white/10 backdrop-blur-sm">
            <div className="flex flex-col md:flex-row md:items-center gap-4">
                <div className="flex-1 text-center md:text-right">
                  <h1 className="text-2xl md:text-3xl font-bold text-white">{material.title}</h1>
                  <p className="text-white/70 mt-2">اختر مدرساً للبدء في التعلم</p>
                </div>
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl font-bold text-white mb-2">المدرسون المتخصصون</h2>
        ...
        {instructors.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-3">لا يوجد مدرسون لهذه المادة</h3>
            <p className="text-white/60 mb-8">لم يتم تعيين أي مدرس لهذه المادة بعد</p>
            <button
              onClick={() => navigate('/')}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {instructors.map((instructor) => {
              ...
              return (
                ...
                >
                  {/* تأثير اللمعان */}
                  <div className={`absolute inset-0 bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-cyan-500/10 rounded-2xl blur-xl transition-opacity duration-500 ${isHovered ? 'opacity-100' : 'opacity-0'}`} />
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        <div className="flex items-center justify-between p-3 md:p-4 bg-gradient-to-r from-purple-500/10 to-purple-500/5 rounded-xl border border-purple-500/20">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="text-sm text-white/60">عدد الفصول</div>
                          </div>
                          <div className="font-bold text-white text-lg md:text-xl">{instructorStats.chapters}</div>
                        </div>
                      </div>
                    </div>
                    {/* تأثير التحليق */}
