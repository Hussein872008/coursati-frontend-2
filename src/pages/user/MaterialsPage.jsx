...
const MaterialsPage = () => {
  ...
  const renderStatsCard = (icon, label, value, color) => (
    <div className={`p-4 rounded-xl bg-gradient-to-br ${color} border border-white/10 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300`}>
    ...
    return (
      <div className="min-h-screen  flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60 text-sm mt-2">جاري تحميل المواد التعليمية</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 p-6">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white">المكتبة التعليمية</h1>
        ...
        {filteredMaterials.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-3">لا توجد مواد متاحة</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredMaterials.map((material) => {
              ...
              return (
                ...
                >
                  {/* تأثير اللمعان */}
                  <div className={`absolute inset-0 bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 rounded-2xl blur-xl transition-opacity duration-500 ${isHovered ? 'opacity-100' : 'opacity-0'}`} />
                    ...
                    <div className="h-40 md:h-56 overflow-hidden relative flex-shrink-0">
                      {material.thumbnailUrl ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-gray-800 to-gray-900 flex flex-col items-center justify-center">
                          ...
                          <span className="text-white/40 mt-2">لا توجد صورة</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="p-4 md:p-5 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto flex items-center justify-between p-3 bg-white/5 rounded-xl">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-white/60">عدد المدرسين</span>
                        </div>
                        <span className="font-bold text-white text-lg md:text-xl">{materialStats.teachers}</span>
                      </div>
                    </div>
